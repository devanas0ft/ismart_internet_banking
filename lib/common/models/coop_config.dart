...
class CoOperative {
  ...
  factory CoOperative.defaultConfig() {
    ...
    // );
    return CoOperative(
      coOperativeName: 'kishanKalyan',
      bannerImage: 'assets/images/kishanKalyan/kishanKalyan_banner.png',
      clientCode: '0F2BNACH4S',
      clientSecret: '115868',
      primaryColor: Color(0xFF008c3f),
      coOperativeLogo: 'assets/images/kishanKalyan/kishanKalyan_logo.png',
      appStoreID: 'com.devanasoft.ismart',
      appTitle: 'Kishan Kalyan iSmart',
      backgroundImage: 'assets/images/kishanKalyan/kishanKalyan_background.png',
      packageName: 'com.devanasoft.ismart',
      splashImage: '',
      channelPartner: '',
    );
