...
class LoanStatementRowWidget extends StatelessWidget {
  final int index;
                ...
                Row(
                  children: [
                    Flexible(
                      flex: 1,
                      child: Center(
                        child: Text(response[index]["tranDate"].toString()),
                      ),
                    ),
                    Flexible(
                      flex: 1,
                    ...
                    Flexible(
                      flex: 1,
                      child: Center(
                        child: Text(response[index]["balance"].toString()),
                      ),
                    ),
                  ],
                ),
                SizedBox(height: 2.hp),
                Text(response[index]["statementReference"]),
              ],
            ),
          ),
        ],
