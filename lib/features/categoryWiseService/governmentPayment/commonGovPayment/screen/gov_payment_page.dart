...
import 'package:ismart_web/features/categoryWiseService/governmentPayment/commonGovPayment/widget/gov_payment_widget.dart';
...
class GovernmentPaymentPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: GovPaymentWidget(service: services),
    );
  }
}
