...
import 'package:ismart_web/features/categoryWiseService/governmentPayment/traffic_fine/widget/traffic_fine_payment_widget.dart';
...
class TrafficFinePaymentPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: TrafficFinePaymentWidget(service: service),
    );
  }
}
