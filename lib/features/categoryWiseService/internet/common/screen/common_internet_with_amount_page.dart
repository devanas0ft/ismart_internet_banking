...
import 'package:ismart_web/features/categoryWiseService/internet/common/widget/common_internet_with_amount_widget.dart';
...
class CommonInternetWithAmountPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: CommonInternetWithAmountWidget(service: service),
    );
  }
}
