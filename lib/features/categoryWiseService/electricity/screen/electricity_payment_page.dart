...
import 'package:ismart_web/features/categoryWiseService/electricity/widget/electricity_payment_widget.dart';
...
class ElectricityPaymentPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: ElectricityPaymentWidget(service: service),
    );
  }
}
