...
import 'package:ismart_web/features/categoryWiseService/airlines/resources/airlines_api_provider.dart';
...
class AirlinesRepository {
  ...
  Future<DataResponse<SearchFlightResponse>> fetchFlights({
    ...
    try {
      ...
      SearchFlightResponse _responseData = SearchFlightResponse.fromJson(
        _res['data'] ?? {},
      );
