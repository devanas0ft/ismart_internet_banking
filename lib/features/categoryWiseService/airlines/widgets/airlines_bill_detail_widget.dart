  ...
  Widget build(BuildContext context) {
    ...
    return PageWrapper(
      ...
      appBar: AppBar(
        elevation: 0,
        backgroundColor: CustomTheme.white,
        title: Text(widget.service.service, style: _textTheme.displaySmall),
      ),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        FlightDetailBox(flight: widget.departureFlight),
                        ...
                        Text("Contact Detail", style: _textTheme.headlineSmall),
                        Container(
                            ...
                            itemBuilder: (context, index) {
                              return Wrap(
                                ...
                                children: [
                                  ...
                                  Text(
                                    widget.passengerList[index]["title"],
                                    style: _theme.textTheme.titleSmall!
                                        .copyWith(fontWeight: FontWeight.w700),
                                  ),
                                  Text(
                                    widget.passengerList[index]["firstName"] +
                                        " " +
                                        widget.passengerList[index]["lastName"],
                                    style: _theme.textTheme.titleSmall!
                                        .copyWith(fontWeight: FontWeight.w700),
                                  ),
                                  Text(
                                    widget.passengerList[index]["nationality"],
                                    style: _theme.textTheme.titleSmall!
                                        .copyWith(fontWeight: FontWeight.w700),
                                  ),
                                  Text(
                                    widget.passengerList[index]["paxType"],
                                    style: _theme.textTheme.titleSmall!
                                        .copyWith(fontWeight: FontWeight.w700),
                                  ),
                                ],
              ...
              child: Column(
                children: [
                  Row(
                    ...
                    children: [
                      Text("Total Paying", style: _textTheme.headlineSmall),
                      Text(
                        "Rs " +
