...
import 'package:ismart_web/features/categoryWiseService/busBooking/screen/bus_booking_page.dart';
import 'package:ismart_web/features/categoryWiseService/electricity/screen/electricity_payment_page.dart';
import 'package:ismart_web/features/categoryWiseService/landline/screen/landline_payment_page.dart';
              ...
              return InkWell(
                onTap: () {
                  ...
                  if (data.uniqueIdentifier.toString().toLowerCase() ==
                      Slugs.brokerPage) {
                    NavigationService.push(
                      target: BrokerPaymentPage(service: data.services.first),
                    );
                  } else if (data.uniqueIdentifier.toString().toLowerCase() ==
                      "electricity") {
                    NavigationService.push(
                      target: ElectricityPaymentPage(service: data.services[0]),
                    );
                  } else if (data.uniqueIdentifier.toString().toLowerCase() ==
                      "airlines") {
                    NavigationService.push(
                    ...
                    NavigationService.push(
                      ...
                      "movies".toLowerCase()) {
                    NavigationService.push(target: MoviePage(category: data));
                  } else if (data.uniqueIdentifier.toString().toLowerCase() ==
                      Slugs.busTicket) {
                    NavigationService.push(
